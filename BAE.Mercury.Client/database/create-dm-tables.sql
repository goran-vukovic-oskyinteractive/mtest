...
insert into DMNode(NodeId, ParentId, NodeName, NodeType, Locked) values(1, 0, 'Ian Brumby', 0, 0) --active, locked
insert into DMNode(NodeId, ParentId, NodeName, Locked) values(2, 1, 'Nerida', 1)
insert into DMNode(NodeId, ParentId, NodeName, Locked) values(3, 1, 'Unit = Set1 2 RAR', 2)
insert into DMNode(NodeId, ParentId, NodeName, NodeType) values(4, 0, 'Set 2', 0)
...
insert into DMNode(NodeId, ParentId, NodeName, NodeType) values(11, 8, '1&2&CCCCCCCC;2&3', 0)
...
insert into DMNode(NodeId, ParentId, NodeName, NodeType) values(46, 32, '1&2&CCCCCCCC', 0)
...
insert into DMNode(NodeId, ParentId, NodeName) values(50, 7, 'APP = AAAA')
insert into DMNode(NodeId, ParentId, NodeName) values(51, 7, 'APP = BBBBB')
insert into DMNode(NodeId, ParentId, NodeName, NodeType) values(52, 50, '1&2&CCCCCCCC', 0)
insert into DMNode(NodeId, ParentId, NodeName, NodeType) values(53, 51, '2&2&CCCCCCCC', 0)
/*
insert into DMNode(NodeId, ParentId, NodeName) values(0, null, 'Root')
