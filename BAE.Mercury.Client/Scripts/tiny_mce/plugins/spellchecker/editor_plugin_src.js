				...
				t._sendRPC('getSuggestions', [t.selectedLang, dom.decode(e.target.innerHTML)], function(r) {
					...
					m.add({
						...
						onclick : function() {
                            ...
                            // Mercury - Added the following line to also perform an 'ignore word' as part of 'ignore all'. In IE8 there were issues with the selected word not being ignored.
						    dom.remove(e.target, 1);
							t._checkDone();
						}
					});
