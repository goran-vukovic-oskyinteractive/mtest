...
(function(jQuery){
  ...
  var NiceScrollClass = function(myopt,me) {
    ...
    this.opt = {
      ...
      smoothscroll:true,
      sensitiverail: true,
      listObject: null // Update ChrisN : Code shouldn't reference global vars in other script files
    };
...
// Nicescroll custom events
    ...
    {
        if (this.opt.listObject) // Update ChrisN : Code shouldn't reference global vars in other script files
        {
            this.opt.listObject.onScrollStart(e);
        }
    };
    this.onscrollend = function (e)
    {
        if (this.opt.listObject) // Update ChrisN : Code shouldn't reference global vars in other script files
        {
            this.opt.listObject.onScrollStop(e);
        }
    };
...
//                      fx = 0;
          ...
          if (cap.cantouch||self.opt.touchbehavior) {
            ...
            self.onmousemove = function(e) {
                ...
                if ( self.rail && self.rail.drag )//--added check for existence of self.rail DA
                {
                if(self.rail.drag.pt!=1)return;
...
//
    ...
    this.hideCursor = function(tm) {
      ...
      self.cursortimeout = setTimeout(function() {
          if ( self.rail && ( !self.rail.active || !self.showonmouseevent ) )//--added check for existence of self.rail DA
          { 
    ...
    this.noticeCursor = function(tm,py,px) {
      ...
      if (self.rail !=null && !self.rail.active) self.hideCursor(tm);
    };
