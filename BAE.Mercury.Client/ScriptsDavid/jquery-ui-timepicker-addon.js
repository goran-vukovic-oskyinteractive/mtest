// =================================================
//          %name: jquery-ui-timepicker-addon.js %
//       %version: 4 %
...
THIS VERSION HAS BEEN HACKED BY BAESYSTEMS 
SEARCH FOR "David" or "ChrisN"
...
(function($) {
		...
		{ 
			...
			*/
			...
			if (this._defaults.timeOnly === true) {
			    ...
			    if (!this._defaults.useDTG) { // ChrisN added switch so we can use non-DTG times as well
			        //version1
	...
	*/
	...
	/*
	* override "Today" button to also grab the time. NOTE: Modifies by David to set UTC date (zulu) on Now button click
	*/
	...
	$.datepicker._gotoToday = function(id) {
        ...
        //get utc datetime for zulu set :David
		var currentDate = new Date();
		var utcDate = new Date( currentDate.getUTCFullYear(),
                                            currentDate.getUTCMonth(),
                                            currentDate.getUTCDate(),
                                            currentDate.getUTCHours(),
                                            currentDate.getUTCMinutes() );
		$( id ).datepicker( "setDate", utcDate );//set UTC date on datepicker (David)
		this._setDate( inst, utcDate );//set UTC date highlight to  correct date on datepicker (David)
		this._setTime( inst, utcDate ); //set UTC time on timepicker (David))
	};
